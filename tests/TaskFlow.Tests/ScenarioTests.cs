...
public class ScenarioTests
{
    ...
    public async Task EmployeeTerminationScenario()
    {
        ...
        var emp1 = await eng.Start("employeeTermination", "sara", new Dictionary<string, object?>
        {
            ["employeeId"] = "1001",
            ["employeeName"] = "رضا محمدی",
        });
        var emp2 = await eng.Start("employeeTermination", "sara", new Dictionary<string, object?>
        {
            ["employeeId"] = "1002",
        ...
        var legal = await eng.AssignTo("sara", new AssignToInput
        {
        ...
        var groupRef = await eng.AssignTo("sara", new AssignToInput
        {
        ...
        var multi = await eng.AssignTo("sara", new AssignToInput
        {
            DefinitionKey = emp1.DefinitionKey,
            ParentInstanceId = emp1.InstanceId,
